...
{    
    public class InternalHeapEdge : HeapEdgeBase
    {
        int hashCode = -1;
        public InternalHeapEdge(HeapVertexBase source, HeapVertexBase target, Field field)
        ...
        {
            if (obj is InternalHeapEdge)
            {
                InternalHeapEdge edge = obj as InternalHeapEdge;
