...
{       
    ...
    {             
        ...
        public StreamWriter outputFileWriter;
        ...
        public static string lambdaDelegateName = "CachedAnonymousMethodDelegate";        
        ...
        public static void InitializeProperties()
        {
            ...
            if (properties.TryGetValue("apppath", out value))            
                PurityAnalysisPhase.AppPath = value + "\\";            
            else
                PurityAnalysisPhase.AppPath = String.Empty;
        ...
        private void InitializeInstanceProperties(Phx.PEModuleUnit moduleunit)
        {
            ...
            if (EnableStats)
            {
                ...
                else throw new ArgumentException("Cannot file the statsfilenamesuffix property");
            }
            ...
            if (EnableLogging)
            {
                ...
                else throw new ArgumentException("Cannot file the logfilenamesuffix property");
            }            
        }
        ...
        protected override void Execute(Phx.Unit unit)
        {
            ...
            this.outputFileWriter.WriteLine("Analysis time: " + sw.Elapsed);
            this.outputFileWriter.WriteLine("# Memory {0} KB",
            ...
            if (properties.TryGetValue("unacallsfilenamesuffix", out value))
                unaCallsWriter = new StreamWriter(new FileStream(PurityAnalysisPhase.outputdir + assemblyname + value,
                    FileMode.Create, FileAccess.Write, FileShare.Read));
            else
                throw new ArgumentException("No unanalyzable calls name specified");
            ...
            if (EnableStats)
            {
                StatisticsManager.GetInstance().DumpCumulativeStats(this.statsFileWriter, reportphase);
        ...
        {           
            ...
            IWorklist<Phx.Graphs.CallNode> worklist = new LRFWorklist<Phx.Graphs.CallNode>();           
