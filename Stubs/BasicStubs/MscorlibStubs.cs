...
namespace Stubs
{
    ...
    public class Thread
    {
        //the followig are new fields defined by the stub on the thread object
        //a mandatory  prefix "stub__" should preceed the names of the fields
        System.Threading.ThreadStart stub__del1;
        System.Threading.ParameterizedThreadStart stub__del2;

        public Thread(System.Threading.ThreadStart st)
        {
            stub__del1 = st;
        }

        public Thread(System.Threading.ParameterizedThreadStart st)
        {
            stub__del2 = st;
        }
        ...
        /// <summary>
        /// TODO: is it safe to make current thead return null ?
        /// </summary>
        /// <returns></returns>
